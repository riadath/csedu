...
class ProfileCardAlumni extends StatefulWidget {
  final String name;
  final String email;
  final String batch;
  final String bloodGroup;
  final String linkedin;
  const ProfileCardAlumni({
    required this.name,
    required this.batch,
  ...
  @override
  State<ProfileCardAlumni> createState() => _ProfileCardAlumniState();
}

class _ProfileCardAlumniState extends State<ProfileCardAlumni> {
